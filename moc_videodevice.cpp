...
**
** Created: Thu Jan 22 21:15:28 2015
...
static const char qt_meta_stringdata_VideoDevice[] = {
    "VideoDevice\0"
};
...
const QMetaObjectExtraData VideoDevice::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject VideoDevice::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VideoDevice,
      qt_meta_data_VideoDevice, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &VideoDevice::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_VideoDevice))
